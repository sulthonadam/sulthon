...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200511_sulthonadammulana_e5e28ca05db893db5861_20200511174826_archive.zip';
	const ARCHIVE_SIZE		 = '57678036';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e5e28ca-11174826';
    const SECONDARY_PACKAGE_HASH = '694a0bb-11174826';
