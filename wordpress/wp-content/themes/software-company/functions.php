...
function rara_business_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Demo Link : ', 'software-company' ), esc_url( __( 'https://demo.rarathemes.com/software-company/', 'software-company' ) ), esc_html__( 'Click here.', 'software-company' ) );
